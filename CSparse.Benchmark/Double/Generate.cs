...
namespace CSparse.Double
{
    ...
    static class Generate
    {
        ...
        /// <param name="eigenvalues">Vector to store eigenvalues (optional).</param>
        /// <returns>Laplacian sparse matrix.</returns>
        public static CompressedColumnStorage<double> Laplacian(int nx, int ny, double[] eigenvalues = null)
        {
            var Ix = Eye(nx);
            var Iy = Eye(ny);
        ...
        private static CompressedColumnStorage<double> Eye(int size)
        {
        ...
        /// </summary>
        private static CompressedColumnStorage<double> Kronecker(CompressedColumnStorage<double> A, CompressedColumnStorage<double> B)
        {
            ...
            var cx = C.Values = new double[nnz];
